...
// Line following / PID
// =========================
static const uint8_t TRACKING_SPEED = 70;   // 0..100
static const uint8_t SEARCH_SPEED   = 60;    // 0..100 (lost line recovery)

static const int8_t MAX_TURN_CMD = 15;       // limit PID output (rot command magnitude)
